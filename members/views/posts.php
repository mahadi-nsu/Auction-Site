...
<div class="posts">
	...
	<section>
		...
		<div class="posts-contents">
			...
			<h3>
				<?php echo $row->title;
				if($row->approval==1) echo " &nbsp; <i class=\"fa fa-check-square\"></i>";
				elseif($row->approval==-1) echo " &nbsp; <i style=\"color:red;\" class=\"fa fa-times\"></i>";
				else echo " &nbsp; <i style=\"color:darkorange;\" class=\"fa fa-spinner\"></i>";?>
			</h3>
